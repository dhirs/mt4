...
input int Take_Profit = 62; // Take Profit (pips)
static input string Ind0 = "------------";// ----- Moving Average -----
input int Ind0Param0 = 37; // Period
input int Ind0Param1 = 0; // Shift
static input string Ind1 = "------------";// ----- Momentum -----
input int Ind1Param0 = 12; // Period
input double Ind1Param1 = 100.0000; // Level
static input string Ind2 = "------------";// ----- ADX -----
input int Ind2Param0 = 25; // Period
input int Ind2Param1 = 0; // Level
static input string Ind3 = "------------";// ----- ADX -----
input int Ind3Param0 = 10; // Period
input int Ind3Param1 = 17; // Level

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 70278882; // Magic Number
...
void ManageOpen()
  {
   double ind0val1 = iMA(NULL,0,Ind0Param0,Ind0Param1,MODE_SMA,PRICE_CLOSE,1);
   double ind0val2 = iMA(NULL,0,Ind0Param0,Ind0Param1,MODE_SMA,PRICE_CLOSE,2);
   bool ind0long  = Open(0) > ind0val1 + sigma && Open(1) < ind0val2 - sigma;
   bool ind0short = Open(0) < ind0val1 - sigma && Open(1) > ind0val2 + sigma;

   double ind1val1 = iMomentum(NULL,0,Ind1Param0,PRICE_CLOSE,1);
   double ind1val2 = iMomentum(NULL,0,Ind1Param0,PRICE_CLOSE,2);
   double ind1val3 = iMomentum(NULL,0,Ind1Param0,PRICE_CLOSE,3);
   ...
   double ind2val1 = iADX(NULL,0,Ind2Param0,PRICE_CLOSE,0,1);
   double ind2val2 = iADX(NULL,0,Ind2Param0,PRICE_CLOSE,0,2);
   double ind2val3 = iADX(NULL,0,Ind2Param0,PRICE_CLOSE,0,3);
...
void ManageClose()
  {
   double ind3val1 = iADX(NULL,0,Ind3Param0,PRICE_CLOSE,0,1);
   double ind3val2 = iADX(NULL,0,Ind3Param0,PRICE_CLOSE,0,2);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"stopLoss":38,"takeProfit":62,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average","listIndexes":[4,0,3,0,0],"numValues":[37,0,0,0,0,0]},{"name":"Momentum","listIndexes":[6,3,0,0,0],"numValues":[12,100,0,0,0,0]},{"name":"ADX","listIndexes":[6,0,0,0,0],"numValues":[25,0,0,0,0,0]}],"closeFilters":[{"name":"ADX","listIndexes":[5,0,0,0,0],"numValues":[10,17,0,0,0,0]}]} */

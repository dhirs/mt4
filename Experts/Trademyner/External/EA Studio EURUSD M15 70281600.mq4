...
input int Stop_Loss   = 71; // Stop Loss (pips)
input int Take_Profit = 16; // Take Profit (pips)
static input string Ind0 = "------------";// ----- Awesome Oscillator -----
input double Ind0Param0 = -0.0033; // Level
static input string Ind1 = "------------";// ----- Accelerator Oscillator -----
input double Ind1Param0 = 0.0005; // Level

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 70281600; // Magic Number
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"stopLoss":71,"takeProfit":16,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Awesome Oscillator","listIndexes":[5,0,0,0,0],"numValues":[-0.0033,0,0,0,0,0]}],"closeFilters":[{"name":"Accelerator Oscillator","listIndexes":[2,0,0,0,0],"numValues":[0.0005,0,0,0,0,0]}]} */

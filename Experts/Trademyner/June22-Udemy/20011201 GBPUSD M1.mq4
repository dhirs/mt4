...
static input double Entry_Amount    = 0.1; // Amount for a new position [lot]
static input double Maximum_Amount  = 0.3; // Maximum position amount [lot]
static input double Adding_Amount   = 0.1; // Amount to add on addition [lot]
static input double Reducing_Amount = 0.1; // Amount to close on reduction [lot]
...
static input string IndicatorName0 = "Moving Average"; // ------ Indicator parameters ------
input int Slot0IndParam0 = 2; // Period
input int Slot0IndParam1 = 0; // Shift
static input string IndicatorName1 = "RSI"; // ------ Indicator parameters ------
input int Slot1IndParam0 = 5; // Smoothing period
input int Slot1IndParam1 = 40; // Level
static input string IndicatorName2 = "Moving Averages Crossover"; // ------ Indicator parameters ------
input int Slot2IndParam0 = 25; // Fast MA period
input int Slot2IndParam1 = 30; // Slow MA period
input int Slot2IndParam2 = 0; // Fast MA shift
input int Slot2IndParam3 = 0; // Slow MA shift
static input string IndicatorName3 = "MACD"; // ------ Indicator parameters ------
input int Slot3IndParam0 = 2; // Slow MA period
...
input int Slot4IndParam0 = 6; // Slow MA period
input int Slot4IndParam1 = 12; // Fast MA period
input int Slot4IndParam2 = 9; // Signal line period
static input string IndicatorName5 = "Stop Limit"; // ------ Indicator parameters ------
input int Slot5IndParam0 = 700; // Stop Loss
input int Slot5IndParam1 = 550; // Take Profit


static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------

// A unique number of the expert's orders.
static input int Expert_Magic = 2153529; // Expert Magic Number
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   Strategy *strategy = new Strategy(4, 0);

   strategy.StrategyName           = "20011201 GBPUSD M1";
   strategy.SameSignalAction       = SameDirSignalAction_Loser;
   strategy.OppSignalAction        = OppositeDirSignalAction_Reduce;
   strategy.MaxOpenLots            = 0.3;
   strategy.UseAccountPercentEntry = false;
   strategy.EntryLots              = 0.1;
   strategy.AddingLots             = 0.1;
   strategy.ReducingLots           = 0.1;
   strategy.MartingaleMultiplier   = Martingale_Multiplier;
   strategy.UseMartingale          = Martingale_Multiplier > 0;
   strategy.Description            = "Exported on 6/2/2022 from Forex Strategy Builder Professional, v3.9.5";
   strategy.RecommendedBars        = 1000;
   strategy.FirstBar               = 8;
   strategy.MinBarsRequired        = 36;
   ...
   strategy.Slot[0].IndicatorName    = "Moving Average";
   ...
   strategy.Slot[0].IndicatorPointer = indicatorManager.CreateIndicator("Moving Average", SlotTypes_Open);
   ...
   strategy.Slot[0].IndicatorPointer.ListParam[0].Text    = "Enter the market at Moving Average";
   ...
   strategy.Slot[0].IndicatorPointer.ListParam[1].Text    = "Simple";
   ...
   strategy.Slot[0].IndicatorPointer.NumParam[1].Caption = "Shift";
   ...
   strategy.Slot[1].IndicatorName    = "RSI";
   ...
   strategy.Slot[1].IndicatorPointer = indicatorManager.CreateIndicator("RSI", SlotTypes_OpenFilter);

   strategy.Slot[1].IndicatorPointer.ListParam[0].Enabled = true;
   strategy.Slot[1].IndicatorPointer.ListParam[0].Caption = "Logic";
   strategy.Slot[1].IndicatorPointer.ListParam[0].Index   = 4;
   strategy.Slot[1].IndicatorPointer.ListParam[0].Text    = "RSI crosses the Level line upward";
   ...
   strategy.Slot[1].IndicatorPointer.NumParam[0].Caption = "Smoothing period";
   strategy.Slot[1].IndicatorPointer.NumParam[0].Value   = Slot1IndParam0;
   strategy.Slot[1].IndicatorPointer.NumParam[1].Enabled = true;
   strategy.Slot[1].IndicatorPointer.NumParam[1].Caption = "Level";
   ...
   strategy.Slot[2].IndicatorName    = "Moving Averages Crossover";
   strategy.Slot[2].SlotType         = SlotTypes_OpenFilter;
   strategy.Slot[2].SignalShift      = 0;
   strategy.Slot[2].SignalRepeat     = 0;
   strategy.Slot[2].IndicatorPeriod  = DataPeriod_M30;
   strategy.Slot[2].IndicatorSymbol  = "";
   strategy.Slot[2].LogicalGroup     = "A";
   strategy.Slot[2].IndicatorPointer = indicatorManager.CreateIndicator("Moving Averages Crossover", SlotTypes_OpenFilter);

   strategy.Slot[2].IndicatorPointer.ListParam[0].Enabled = true;
   strategy.Slot[2].IndicatorPointer.ListParam[0].Caption = "Logic";
   strategy.Slot[2].IndicatorPointer.ListParam[0].Index   = 2;
   strategy.Slot[2].IndicatorPointer.ListParam[0].Text    = "Fast MA is higher than Slow MA";
   strategy.Slot[2].IndicatorPointer.ListParam[1].Enabled = true;
   strategy.Slot[2].IndicatorPointer.ListParam[1].Caption = "Base price";
   strategy.Slot[2].IndicatorPointer.ListParam[1].Index   = 3;
   strategy.Slot[2].IndicatorPointer.ListParam[1].Text    = "Close";
   strategy.Slot[2].IndicatorPointer.ListParam[3].Enabled = true;
   strategy.Slot[2].IndicatorPointer.ListParam[3].Caption = "Fast MA method";
   strategy.Slot[2].IndicatorPointer.ListParam[3].Index   = 0;
   strategy.Slot[2].IndicatorPointer.ListParam[3].Text    = "Simple";
   strategy.Slot[2].IndicatorPointer.ListParam[4].Enabled = true;
   strategy.Slot[2].IndicatorPointer.ListParam[4].Caption = "Slow MA method";
   strategy.Slot[2].IndicatorPointer.ListParam[4].Index   = 0;
   strategy.Slot[2].IndicatorPointer.ListParam[4].Text    = "Simple";

   strategy.Slot[2].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[2].IndicatorPointer.NumParam[0].Caption = "Fast MA period";
   strategy.Slot[2].IndicatorPointer.NumParam[0].Value   = Slot2IndParam0;
   strategy.Slot[2].IndicatorPointer.NumParam[1].Enabled = true;
   strategy.Slot[2].IndicatorPointer.NumParam[1].Caption = "Slow MA period";
   strategy.Slot[2].IndicatorPointer.NumParam[1].Value   = Slot2IndParam1;
   strategy.Slot[2].IndicatorPointer.NumParam[2].Enabled = true;
   strategy.Slot[2].IndicatorPointer.NumParam[2].Caption = "Fast MA shift";
   strategy.Slot[2].IndicatorPointer.NumParam[2].Value   = Slot2IndParam2;
   strategy.Slot[2].IndicatorPointer.NumParam[3].Enabled = true;
   strategy.Slot[2].IndicatorPointer.NumParam[3].Caption = "Slow MA shift";
   strategy.Slot[2].IndicatorPointer.NumParam[3].Value   = Slot2IndParam3;
   ...
   strategy.Slot[3].IndicatorName    = "MACD";
   strategy.Slot[3].SlotType         = SlotTypes_OpenFilter;
   strategy.Slot[3].SignalShift      = 0;
   strategy.Slot[3].SignalRepeat     = 0;
   strategy.Slot[3].IndicatorPeriod  = DataPeriod_M30;
   strategy.Slot[3].IndicatorSymbol  = "";
   strategy.Slot[3].LogicalGroup     = "A";
   strategy.Slot[3].IndicatorPointer = indicatorManager.CreateIndicator("MACD", SlotTypes_OpenFilter);

   strategy.Slot[3].IndicatorPointer.ListParam[0].Enabled = true;
   strategy.Slot[3].IndicatorPointer.ListParam[0].Caption = "Logic";
   strategy.Slot[3].IndicatorPointer.ListParam[0].Index   = 10;
   strategy.Slot[3].IndicatorPointer.ListParam[0].Text    = "MACD line is higher than the Signal line";
   ...
   strategy.Slot[3].IndicatorPointer.ListParam[3].Enabled = true;
   strategy.Slot[3].IndicatorPointer.ListParam[3].Caption = "Signal line method";
   strategy.Slot[3].IndicatorPointer.ListParam[3].Index   = 0;
   strategy.Slot[3].IndicatorPointer.ListParam[3].Text    = "Simple";

   strategy.Slot[3].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[3].IndicatorPointer.NumParam[0].Caption = "Slow MA period";
   strategy.Slot[3].IndicatorPointer.NumParam[0].Value   = Slot3IndParam0;
   strategy.Slot[3].IndicatorPointer.NumParam[1].Enabled = true;
   strategy.Slot[3].IndicatorPointer.NumParam[1].Caption = "Fast MA period";
   strategy.Slot[3].IndicatorPointer.NumParam[1].Value   = Slot3IndParam1;
   strategy.Slot[3].IndicatorPointer.NumParam[2].Enabled = true;
   strategy.Slot[3].IndicatorPointer.NumParam[2].Caption = "Signal line period";
   strategy.Slot[3].IndicatorPointer.NumParam[2].Value   = Slot3IndParam2;
   ...
   strategy.Slot[4].IndicatorName    = "MACD";
   strategy.Slot[4].SlotType         = SlotTypes_OpenFilter;
   strategy.Slot[4].SignalShift      = 0;
   strategy.Slot[4].SignalRepeat     = 0;
   strategy.Slot[4].IndicatorPeriod  = DataPeriod_H1;
   strategy.Slot[4].IndicatorSymbol  = "";
   strategy.Slot[4].LogicalGroup     = "A";
   strategy.Slot[4].IndicatorPointer = indicatorManager.CreateIndicator("MACD", SlotTypes_OpenFilter);

   strategy.Slot[4].IndicatorPointer.ListParam[0].Enabled = true;
   strategy.Slot[4].IndicatorPointer.ListParam[0].Caption = "Logic";
   strategy.Slot[4].IndicatorPointer.ListParam[0].Index   = 10;
   strategy.Slot[4].IndicatorPointer.ListParam[0].Text    = "MACD line is higher than the Signal line";
   ...
   strategy.Slot[4].IndicatorPointer.ListParam[2].Index   = 3;
   strategy.Slot[4].IndicatorPointer.ListParam[2].Text    = "Close";
   strategy.Slot[4].IndicatorPointer.ListParam[3].Enabled = true;
   strategy.Slot[4].IndicatorPointer.ListParam[3].Caption = "Signal line method";
   strategy.Slot[4].IndicatorPointer.ListParam[3].Index   = 0;
   strategy.Slot[4].IndicatorPointer.ListParam[3].Text    = "Simple";

   strategy.Slot[4].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[4].IndicatorPointer.NumParam[0].Caption = "Slow MA period";
   strategy.Slot[4].IndicatorPointer.NumParam[0].Value   = Slot4IndParam0;
   strategy.Slot[4].IndicatorPointer.NumParam[1].Enabled = true;
   strategy.Slot[4].IndicatorPointer.NumParam[1].Caption = "Fast MA period";
   strategy.Slot[4].IndicatorPointer.NumParam[1].Value   = Slot4IndParam1;
   strategy.Slot[4].IndicatorPointer.NumParam[2].Enabled = true;
   strategy.Slot[4].IndicatorPointer.NumParam[2].Caption = "Signal line period";
   strategy.Slot[4].IndicatorPointer.NumParam[2].Value   = Slot4IndParam2;
   ...
   strategy.Slot[5].IndicatorName    = "Stop Limit";
   strategy.Slot[5].SlotType         = SlotTypes_Close;
   ...
   strategy.Slot[5].LogicalGroup     = "";
   strategy.Slot[5].IndicatorPointer = indicatorManager.CreateIndicator("Stop Limit", SlotTypes_Close);
   ...
   strategy.Slot[5].IndicatorPointer.ListParam[0].Text    = "Exit at Stop Loss or at Take Profit";

   strategy.Slot[5].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[5].IndicatorPointer.NumParam[0].Caption = "Stop Loss";
   strategy.Slot[5].IndicatorPointer.NumParam[0].Value   = Slot5IndParam0;
   strategy.Slot[5].IndicatorPointer.NumParam[1].Enabled = true;
   strategy.Slot[5].IndicatorPointer.NumParam[1].Caption = "Take Profit";
...
/*STRATEGY CODE <?xml version=\"1.0\"?><strategy><programName>Forex Strategy Builder Professional</programName><programVersion>v3.9.5</programVersion><strategyName>20011201 GBPUSD M1</strategyName><profileName>Default profile</profileName><dataSourceName>FSB Demo data</dataSourceName><instrumentSymbol>GBPUSD</instrumentSymbol><instrumentPeriod>1</instrumentPeriod><sameDirSignalAction>Loser</sameDirSignalAction><oppDirSignalAction>Reduce</oppDirSignalAction><maxOpenLots>0.3</maxOpenLots><useAccountPercentEntry>False</useAccountPercentEntry><entryLots>0.1</entryLots><addingLots>0.1</addingLots><reducingLots>0.1</reducingLots><useMartingale>False</useMartingale><martingaleMultiplier>2</martingaleMultiplier><description>Exported on 6/2/2022 from Forex Strategy Builder Professional, v3.9.5</description><recommendedBars>1000</recommendedBars><openFilters>4</openFilters><closeFilters>0</closeFilters><firstBar>8</firstBar><minBarsRequired>36</minBarsRequired><permanentStopLoss usePermanentSL=\"False\" permanentSLType=\"Relative\">800</permanentStopLoss><permanentTakeProfit usePermanentTP=\"False\" permanentTPType=\"Relative\">1000</permanentTakeProfit><breakEven useBreakEven=\"False\">1000</breakEven><slot slotNumber=\"0\" slotType=\"Open\"><indicatorName>Moving Average</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Enter the market at Moving Average</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><numParam paramNumber=\"0\"><caption>Period</caption><value>2</value></numParam><numParam paramNumber=\"1\"><caption>Shift</caption><value>0</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"1\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>RSI</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>4</index><value>RSI crosses the Level line upward</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><numParam paramNumber=\"0\"><caption>Smoothing period</caption><value>5</value></numParam><numParam paramNumber=\"1\"><caption>Level</caption><value>40</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"2\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>Moving Averages Crossover</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>2</index><value>Fast MA is higher than Slow MA</value></listParam><listParam paramNumber=\"1\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><listParam paramNumber=\"3\"><caption>Fast MA method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"4\"><caption>Slow MA method</caption><index>0</index><value>Simple</value></listParam><numParam paramNumber=\"0\"><caption>Fast MA period</caption><value>25</value></numParam><numParam paramNumber=\"1\"><caption>Slow MA period</caption><value>30</value></numParam><numParam paramNumber=\"2\"><caption>Fast MA shift</caption><value>0</value></numParam><numParam paramNumber=\"3\"><caption>Slow MA shift</caption><value>0</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M30</indicatorPeriod></slot><slot slotNumber=\"3\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>MACD</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>10</index><value>MACD line is higher than the Signal line</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><listParam paramNumber=\"3\"><caption>Signal line method</caption><index>0</index><value>Simple</value></listParam><numParam paramNumber=\"0\"><caption>Slow MA period</caption><value>2</value></numParam><numParam paramNumber=\"1\"><caption>Fast MA period</caption><value>12</value></numParam><numParam paramNumber=\"2\"><caption>Signal line period</caption><value>9</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M30</indicatorPeriod></slot><slot slotNumber=\"4\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>MACD</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>10</index><value>MACD line is higher than the Signal line</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><listParam paramNumber=\"3\"><caption>Signal line method</caption><index>0</index><value>Simple</value></listParam><numParam paramNumber=\"0\"><caption>Slow MA period</caption><value>6</value></numParam><numParam paramNumber=\"1\"><caption>Fast MA period</caption><value>12</value></numParam><numParam paramNumber=\"2\"><caption>Signal line period</caption><value>9</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>H1</indicatorPeriod></slot><slot slotNumber=\"5\" slotType=\"Close\"><indicatorName>Stop Limit</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Exit at Stop Loss or at Take Profit</value></listParam><numParam paramNumber=\"0\"><caption>Stop Loss</caption><value>700</value></numParam><numParam paramNumber=\"1\"><caption>Take Profit</caption><value>550</value></numParam></slot></strategy> */
//+------------------------------------------------------------------+

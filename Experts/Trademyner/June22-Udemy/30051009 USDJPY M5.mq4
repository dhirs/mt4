...
input int Slot0IndParam0 = 9; // Tenkan
input int Slot0IndParam2 = 25; // Kijun
input int Slot0IndParam4 = 36; // Senkou Span B
static input string IndicatorName1 = "MACD"; // ------ Indicator parameters ------
input int Slot1IndParam0 = 10; // Slow MA period
input int Slot1IndParam1 = 12; // Fast MA period
input int Slot1IndParam2 = 9; // Signal line period
static input string IndicatorName2 = "MACD"; // ------ Indicator parameters ------
input int Slot2IndParam0 = 6; // Slow MA period
input int Slot2IndParam1 = 12; // Fast MA period
input int Slot2IndParam2 = 9; // Signal line period
static input string IndicatorName3 = "Williams' Percent Range"; // ------ Indicator parameters ------
input int Slot3IndParam0 = 15; // Period of %R
input int Slot3IndParam1 = 30; // Smoothing period
input int Slot3IndParam2 = -20; // Level
static input string IndicatorName4 = "Stop Limit"; // ------ Indicator parameters ------
input int Slot4IndParam0 = 820; // Stop Loss
input int Slot4IndParam1 = 780; // Take Profit


static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------

// A unique number of the expert's orders.
static input int Expert_Magic = 2153513; // Expert Magic Number
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.StrategyName           = "30051008";
   ...
   strategy.FirstBar               = 39;
   strategy.MinBarsRequired        = 42;
   ...
   strategy.Slot[0].IndicatorName    = "Ichimoku Kinko Hyo";
   ...
   strategy.Slot[0].IndicatorPointer = indicatorManager.CreateIndicator("Ichimoku Kinko Hyo", SlotTypes_Open);

   strategy.Slot[0].IndicatorPointer.ListParam[0].Enabled = true;
   strategy.Slot[0].IndicatorPointer.ListParam[0].Caption = "Logic";
   strategy.Slot[0].IndicatorPointer.ListParam[0].Index   = 1;
   strategy.Slot[0].IndicatorPointer.ListParam[0].Text    = "Enter the market at Kijun Sen";

   strategy.Slot[0].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[0].IndicatorPointer.NumParam[0].Caption = "Tenkan";
   strategy.Slot[0].IndicatorPointer.NumParam[0].Value   = Slot0IndParam0;
   strategy.Slot[0].IndicatorPointer.NumParam[2].Enabled = true;
   strategy.Slot[0].IndicatorPointer.NumParam[2].Caption = "Kijun";
   strategy.Slot[0].IndicatorPointer.NumParam[2].Value   = Slot0IndParam2;
   strategy.Slot[0].IndicatorPointer.NumParam[4].Enabled = true;
   strategy.Slot[0].IndicatorPointer.NumParam[4].Caption = "Senkou Span B";
   strategy.Slot[0].IndicatorPointer.NumParam[4].Value   = Slot0IndParam4;
   ...
   strategy.Slot[1].IndicatorName    = "MACD";
   ...
   strategy.Slot[1].IndicatorPointer = indicatorManager.CreateIndicator("MACD", SlotTypes_OpenFilter);
   ...
   strategy.Slot[1].IndicatorPointer.ListParam[0].Text    = "MACD line is lower than the Signal line";
   ...
   strategy.Slot[2].IndicatorName    = "MACD";
   ...
   strategy.Slot[2].IndicatorPointer = indicatorManager.CreateIndicator("MACD", SlotTypes_OpenFilter);

   strategy.Slot[2].IndicatorPointer.ListParam[0].Enabled = true;
   strategy.Slot[2].IndicatorPointer.ListParam[0].Caption = "Logic";
   strategy.Slot[2].IndicatorPointer.ListParam[0].Index   = 3;
   strategy.Slot[2].IndicatorPointer.ListParam[0].Text    = "MACD line is lower than zero";
   ...
   strategy.Slot[2].IndicatorPointer.ListParam[3].Caption = "Signal line method";
   ...
   strategy.Slot[3].IndicatorName    = "Williams' Percent Range";
   ...
   strategy.Slot[3].IndicatorPointer = indicatorManager.CreateIndicator("Williams' Percent Range", SlotTypes_OpenFilter);
   ...
   strategy.Slot[3].IndicatorPointer.ListParam[0].Text    = "WPR changes its direction upward";
   ...
   strategy.Slot[3].IndicatorPointer.ListParam[1].Index   = 2;
   strategy.Slot[3].IndicatorPointer.ListParam[1].Text    = "Exponential";

   strategy.Slot[3].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[3].IndicatorPointer.NumParam[0].Caption = "Period of %R";
   strategy.Slot[3].IndicatorPointer.NumParam[0].Value   = Slot3IndParam0;
   strategy.Slot[3].IndicatorPointer.NumParam[1].Enabled = true;
   strategy.Slot[3].IndicatorPointer.NumParam[1].Caption = "Smoothing period";
   strategy.Slot[3].IndicatorPointer.NumParam[1].Value   = Slot3IndParam1;
   strategy.Slot[3].IndicatorPointer.NumParam[2].Enabled = true;
   strategy.Slot[3].IndicatorPointer.NumParam[2].Caption = "Level";
   ...
   strategy.Slot[4].IndicatorName    = "Stop Limit";
   ...
   strategy.Slot[4].IndicatorPointer = indicatorManager.CreateIndicator("Stop Limit", SlotTypes_Close);
   ...
   strategy.Slot[4].IndicatorPointer.ListParam[0].Text    = "Exit at Stop Loss or at Take Profit";

   strategy.Slot[4].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[4].IndicatorPointer.NumParam[0].Caption = "Stop Loss";
   strategy.Slot[4].IndicatorPointer.NumParam[0].Value   = Slot4IndParam0;
   strategy.Slot[4].IndicatorPointer.NumParam[1].Enabled = true;
   strategy.Slot[4].IndicatorPointer.NumParam[1].Caption = "Take Profit";
...
/*STRATEGY CODE <?xml version=\"1.0\"?><strategy><programName>Forex Strategy Builder Professional</programName><programVersion>v3.9.5</programVersion><strategyName>30051008</strategyName><profileName>Default profile</profileName><dataSourceName>FSB Demo data</dataSourceName><instrumentSymbol>USDJPY</instrumentSymbol><instrumentPeriod>5</instrumentPeriod><sameDirSignalAction>Loser</sameDirSignalAction><oppDirSignalAction>Reduce</oppDirSignalAction><maxOpenLots>0.3</maxOpenLots><useAccountPercentEntry>False</useAccountPercentEntry><entryLots>0.1</entryLots><addingLots>0.1</addingLots><reducingLots>0.1</reducingLots><useMartingale>False</useMartingale><martingaleMultiplier>2</martingaleMultiplier><description>Exported on 6/2/2022 from Forex Strategy Builder Professional, v3.9.5</description><recommendedBars>1000</recommendedBars><openFilters>3</openFilters><closeFilters>0</closeFilters><firstBar>39</firstBar><minBarsRequired>42</minBarsRequired><permanentStopLoss usePermanentSL=\"False\" permanentSLType=\"Relative\">1000</permanentStopLoss><permanentTakeProfit usePermanentTP=\"False\" permanentTPType=\"Relative\">600</permanentTakeProfit><breakEven useBreakEven=\"False\">1000</breakEven><slot slotNumber=\"0\" slotType=\"Open\"><indicatorName>Ichimoku Kinko Hyo</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>1</index><value>Enter the market at Kijun Sen</value></listParam><numParam paramNumber=\"0\"><caption>Tenkan</caption><value>9</value></numParam><numParam paramNumber=\"2\"><caption>Kijun</caption><value>25</value></numParam><numParam paramNumber=\"4\"><caption>Senkou Span B</caption><value>36</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"1\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>MACD</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>11</index><value>MACD line is lower than the Signal line</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>2</index><value>Exponential</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><listParam paramNumber=\"3\"><caption>Signal line method</caption><index>0</index><value>Simple</value></listParam><numParam paramNumber=\"0\"><caption>Slow MA period</caption><value>10</value></numParam><numParam paramNumber=\"1\"><caption>Fast MA period</caption><value>12</value></numParam><numParam paramNumber=\"2\"><caption>Signal line period</caption><value>9</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>H1</indicatorPeriod></slot><slot slotNumber=\"2\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>MACD</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>3</index><value>MACD line is lower than zero</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>2</index><value>Exponential</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><listParam paramNumber=\"3\"><caption>Signal line method</caption><index>0</index><value>Simple</value></listParam><numParam paramNumber=\"0\"><caption>Slow MA period</caption><value>6</value></numParam><numParam paramNumber=\"1\"><caption>Fast MA period</caption><value>12</value></numParam><numParam paramNumber=\"2\"><caption>Signal line period</caption><value>9</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M30</indicatorPeriod></slot><slot slotNumber=\"3\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>Williams' Percent Range</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>6</index><value>WPR changes its direction upward</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>2</index><value>Exponential</value></listParam><numParam paramNumber=\"0\"><caption>Period of %R</caption><value>15</value></numParam><numParam paramNumber=\"1\"><caption>Smoothing period</caption><value>30</value></numParam><numParam paramNumber=\"2\"><caption>Level</caption><value>-20</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"4\" slotType=\"Close\"><indicatorName>Stop Limit</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Exit at Stop Loss or at Take Profit</value></listParam><numParam paramNumber=\"0\"><caption>Stop Loss</caption><value>820</value></numParam><numParam paramNumber=\"1\"><caption>Take Profit</caption><value>780</value></numParam></slot></strategy> */
//+------------------------------------------------------------------+

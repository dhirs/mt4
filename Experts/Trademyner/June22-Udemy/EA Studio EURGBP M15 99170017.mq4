...
static input double Entry_Amount =     0.10; // Entry lots
       input int    Stop_Loss    =       70; // Stop Loss   (pips)
       input int    Take_Profit  =       50; // Take Profit (pips)

static input string ___0______   = "------"; // --- Accelerator Oscillator ---
       input double Ind0Param0   =  -0.0001; // Level

static input string ___1______   = "------"; // --- Moving Averages Crossover ---
       input int    Ind1Param0   =       31; // Fast MA period
       input int    Ind1Param1   =       33; // Slow MA period

static input string ___2______   = "------"; // --- Alligator ---
       input int    Ind2Param0   =       56; // Jaws period
       input int    Ind2Param1   =       20; // Jaws shift
       input int    Ind2Param2   =       22; // Teeth period
...
static input int    Magic_Number = 99170017; // Magic Number
...
int GetEntrySignal()
  {
   // Accelerator Oscillator, Level: -0.0001
   ...
   // Moving Averages Crossover (Simple, Simple, 31, 33)
...
void ManageClose()
  {
   // Alligator (Smoothed, Median, 56, 20, 22, 25, 10, 5)
   ...
   double ind2val3  = iAlligator(NULL, 0, Ind2Param0, Ind2Param1, Ind2Param2, Ind2Param3, Ind2Param4, Ind2Param5, MODE_SMMA, PRICE_MEDIAN, MODE_GATORTEETH, 2);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":70,"takeProfit":50,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Accelerator Oscillator","listIndexes":[5,0,0,0,0],"numValues":[-0.0001,0,0,0,0,0]},{"name":"Moving Averages Crossover","listIndexes":[3,0,0,0,0],"numValues":[31,33,0,0,0,0]}],"closeFilters":[{"name":"Alligator","listIndexes":[10,3,4,0,0],"numValues":[56,20,22,25,10,5]}]} */

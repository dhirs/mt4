...
input int Take_Profit = 95; // Take Profit (pips)
static input string Ind0 = "------------";// ----- Moving Average -----
input int Ind0Param0 = 21; // Period
input int Ind0Param1 = 0; // Shift
static input string Ind1 = "------------";// ----- Accelerator Oscillator -----
input double Ind1Param0 = 0.0000; // Level
static input string Ind2 = "------------";// ----- Commodity Channel Index -----
input int Ind2Param0 = 27; // Period
input int Ind2Param1 = -84; // Level

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 70395048; // Magic Number
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"stopLoss":73,"takeProfit":95,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average","listIndexes":[5,0,3,0,0],"numValues":[21,0,0,0,0,0]},{"name":"Accelerator Oscillator","listIndexes":[1,0,0,0,0],"numValues":[0,0,0,0,0,0]}],"closeFilters":[{"name":"Commodity Channel Index","listIndexes":[4,5,0,0,0],"numValues":[27,-84,0,0,0,0]}]} */
